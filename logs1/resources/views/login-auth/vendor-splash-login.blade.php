...
<head>
    ...
    <title>Vendor Login Splash</title>
        ...
        <div class="w-full max-w-md relative z-10">
            <div class="bg-white/90 backdrop-blur-lg rounded-2xl shadow-2xl p-8 flex flex-col items-center space-y-4 opacity-0 animate-entrance-pop">
                ...
                <div role="status" aria-live="polite" class="flex items-center space-x-3">
                    ...
                    <span class="text-brand-text-primary font-medium text-lg">Logging in…</span>
                </div>
                <p class="text-sm text-brand-text-secondary text-center">Secure access to your Vendors Portal.</p>
            </div>
        </div>
    </main>
    <script>
        setTimeout(() => { window.location.href = '/vendor/home'; }, 2000);
    </script>
</body>
</html>