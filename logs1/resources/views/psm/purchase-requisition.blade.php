            ...
            <div id="viewModeContent" class="hidden space-y-6">
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-100 grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <p id="view_req_chosen_vendor" class="text-sm font-bold text-emerald-600"></p>
                    </div>
                </div>
    ...
    <div class="flex gap-6 w-full max-w-7xl px-4 items-start">
        ...
        <div id="sideRequisitionContainer" class="bg-white rounded-xl p-6 w-full max-w-2xl max-h-[85vh] overflow-y-auto shadow-2xl transition-all transform">
            ...
            <form id="sideRequisitionForm" class="space-y-4">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Chosen Vendor</label>
                    <input type="text" id="side_req_chosen_vendor_display" placeholder="Select a vendor from the products modal" readonly class="w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 cursor-not-allowed">
                    <input type="hidden" id="side_req_chosen_vendor" name="req_chosen_vendor">
                </div>
