        ...
        <div id="sideRequisitionContainer" class="bg-white rounded-xl p-6 w-full max-w-2xl max-h-[85vh] overflow-y-auto shadow-2xl transition-all transform">
            ...
            <form id="sideRequisitionForm" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="side_req_chosen_vendor" name="req_chosen_vendor" placeholder="Select a vendor from the products modal" readonly class="w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 cursor-not-allowed">
                </div>
